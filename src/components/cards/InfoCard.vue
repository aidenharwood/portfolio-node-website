<template>
  <section
    ...
    <section class="flex-col content-center justify-center items-center w-full mr-3 lg:mr-0">
      <h2 class="text-xl lg:text-3xl font-bold">Aiden Harwood</h2>
      <h2 class="text-lg lg:text-2xl font-semibold mb-4 text-muted-foreground">
        DevOps Engineer
      </h2>
      <section class="text-foreground items-center space-x-4 text-2xl">
        <a class="pi pi-github hover:text-accent transition-colors" href="https://github.com/aidenharwood/" />
        <a class="pi pi-linkedin hover:text-accent transition-colors" href="https://www.linkedin.com/in/aiden-harwood-026ab3174/" />
        <a class="pi pi-at hover:text-accent transition-colors" href="mailto:aiden.harwood96@gmail.com" />
      </section>
    </section>
  </section>
</template>
